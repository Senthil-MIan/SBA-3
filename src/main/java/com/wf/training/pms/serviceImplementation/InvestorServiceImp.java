...
import com.wf.training.pms.entity.ShareTransaction;
...
import com.wf.training.pms.repository.PortfolioReportRepository;
import com.wf.training.pms.repository.RecentViewCompRepository;
import com.wf.training.pms.service.InvestorService;
import com.wf.training.pms.repository.ShareTransactionRepository;
...
public class InvestorServiceImp implements InvestorService {
	...
	public double getWalletBalance(LoginDto investorLoginDto) {
		...
		return this.getWalletBalance(investor.getLoginKey());
	}
...
public ShareTransactionDto convertShareTransactionEntityToDto(ShareTransaction shareTransaction) {
		...
		shareTransactionDto.setCompanyCommodity(shareTransaction.
				getCompanyCommodity());
